...
import com.wlp.crique.utils.BitmapUtils;
import com.wlp.crique.utils.ChartUtils;
import com.wlp.crique.utils.DensityUtils;
...
public class CirqueProgressControlView extends View {
    ...
    private void initParams() {
        mLineStrokeWidth = DensityUtils.dip2px(mContext, 6.f);
        mBlurMaskRadius = DensityUtils.dip2px(mContext, 30.f);
    ...
    private void initPaint() {
        ...
        mTextPaint.setTextSize(DensityUtils.dip2px(mContext, 20));
        ...
        mDragBitmap = BitmapUtils.conversionBitmap(mDragBitmap, DensityUtils.dip2px(mContext,
                45), DensityUtils.dip2px(mContext, 45));
        mOval = new RectF();
    }
                ...
                if (mIsTouchOnArc) {
                    ...
                    if (mOnCirqueProgressChangeListener != null)
                        mOnCirqueProgressChangeListener.onChange(mMinProgress, mMaxProgress,
                                Integer.parseInt(mText.replace("雾量", "")));
                }
                break;
